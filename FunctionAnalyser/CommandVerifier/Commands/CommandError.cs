...
namespace CommandVerifier.Commands
{
    ...
    {
        public static List<string> StoredErrors { get; }
        private readonly string Message;

        static CommandError()
        {
            StoredErrors = new List<string>();
        }
        ...
        public static CommandError ExpectedValueForEntityOption(string option) => new CommandError($"Expected value for option '{option}'");
        public static CommandError ExpectedEndOfOptions() => new CommandError("Expected end of options");
        ...
        public static CommandError UnknownParticle(Types.NamespacedId particle) => new CommandError($"Unknown particle: {particle}");
